                    ...
                    <form class="col s12" method="post">
                        <div class='row'>
                            <div class='input-field col s6'>
                                <label for="first_name">
                                    <i class="fas fa-ellipsis-h"></i> First name
                                </label>
                                <input class="validate" type="text" name="first_name" id="first_name">
                            </div>
                            <div class='input-field col s6'>
                                <label for="last_name">
                                    <i class="fas fa-ellipsis-h"></i> Last name
                                </label>
                        ...
                        <div class='row'>
                            <div class="input-field col s12">
                                ...
                                <input type="tel" class="validate" name="phone" id="phone">
                            </div>
                        </div>
                        ...
                        <div class='row'>
                            <div class='input-field col s12'>
                                ...
                                <input class='validate' type='password' name='repeat_password' id='repeat_password' />
                            </div>
                        </div>

                        <div class="center">
                            <div class='row'>
                                <button type='button' name='btn_login' class='col s12 btn btn-large waves-effect indigo'>Sign Up</button>
                            </div>
                        </div>
                    </form>
                </div>
